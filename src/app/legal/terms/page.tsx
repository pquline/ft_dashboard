      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <Card className="card-modern glass-hover group overflow-hidden mb-8">
          ...
          <CardContent className="space-y-4 text-foreground/90 relative z-10">
            ...
            <p>
              By using our Service, you agree to these Terms. We do not collect,
              store, or process any data. This service simply facilitates
              communication between your browser and 42 Paris.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="card-modern glass-hover group overflow-hidden mt-8">
          ...
          <CardContent className="space-y-4 text-foreground/90 relative z-10">
            <p>
              ...
              are the property of ft_dashboard. The Service is protected by
        ...
        <Card className="card-modern glass-hover group overflow-hidden mt-8">
          ...
          <CardContent className="space-y-4 text-foreground/90 relative z-10">
            <p>
              You may stop using the service at any time by clearing your
              browser cookies.
            </p>
            <p>
              Since we do not store any data, there is no account to terminate
              or suspend.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="card-modern glass-hover group overflow-hidden mt-8">
          ...
          <CardContent className="space-y-4 text-foreground/90 relative z-10">
            <p>
              If you have any questions about these Terms of Service or how our
