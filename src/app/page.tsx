                      ...
                      <BarChart accessibilityLayer data={chartData}>
                        ...
                        />
                          ...
                          {chartData.map((entry, index) => {
                            ...
                            let color;
                            // Color gradient based on attendance value
                            if (value < 2) color = '#ff6b6b'; // Red for low attendance
                            else if (value < 4) color = '#ffa726'; // Orange for medium-low
                            else if (value < 6) color = '#ffd54f'; // Yellow for medium
                            else if (value < 8) color = '#66bb6a'; // Green for medium-high
                            else color = '#42a5f5'; // Blue for high attendance
